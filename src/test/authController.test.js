...
jest.mock('../models/userModel.js');  // Simula el modelo User
...
describe('Auth Controller', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();  // Limpia cualquier llamada previa a los mocks
    ...
    // Mock User.findOne behavior here (outside of individual tests)
    User.findOne.mockResolvedValueOnce(null); // Simulate no existing user (for first test)
  });
